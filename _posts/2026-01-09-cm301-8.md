...
<img src="{{ 'assets/img/illustration/cm301/8_2.png' | absolute_url }}" alt="image2" class="post" />마시멜로
...
<img src="{{ 'assets/img/illustration/cm301/8_13.png' | absolute_url }}" alt="image13" class="post" /> 이미 MST에 포함되어 있던 선들 + 절단 성질에 의해 MST에 포함됨이 증명된 선 e
...
가장 먼저 끝나는 수업을 선택한 일정은 최적의 일정이 될 수 있다.
