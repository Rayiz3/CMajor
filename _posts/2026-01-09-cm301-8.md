...
- **make_set(x: Vertex) :** v만 존재하는 집합 $\lbracev\rbrace$를 생성
...
<img src="{{ 'assets/img/illustration/cm301/8_11.png' | absolute_url }}" alt="image11" class="post" />
 ...
 &ensp;여기에 $e$를 집어 넣고 $e’$를 빼서 새로운 그래프 $T = T’ + \lbracee\rbrace - \lbracee’\rbrace$를 만들어봅시다.
...
<img src="{{ 'assets/img/illustration/cm301/8_21.png' | absolute_url }}" alt="image21" class="post" />
 ...
 &ensp;$X$에는 $f$와 시간이 겹치는 일정 $g$가 존재하고, $f$는 가장 먼저 끝나는 수업이기 때문에 $g$는 반드시 $f$보다 늦게 끝나는 수업이어야 합니다. 따라서 $X - \lbraceg\rbrace$ 도 $f$와 시간이 겹칠 수 없습니다.
