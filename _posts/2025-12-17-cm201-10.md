...
- 출력값을 내놓는 함수 $g : \; S \times I \rightarrow O$
 ...
 &ensp;위의 값들로 정의되는 유한 상태 기계 $M$은 아래와 같이 정의할 수 있습니다.
...
<img src="{{ 'assets/img/illustration/cm201/10_13.png' | absolute_url }}" alt="image13" class="post" />
 ...
 &ensp;이렇게 우리는 또 하나의 상태 기계를 만들었는데, 이전과는 달리 출력값이 없는데다 상태의 적합 여부도 판단할 수 있게 되었습니다. 이를 **유한 상태 오토마타(Finite State Automata, FSA)**라고 합니다. 적합하다고 판단되는 상태는 **수용 상태(Accepting state)** 또는 **최종 상태(Final state)**라고 하고요.
